...
class Shape: UIView {
  ...
  override func layoutSubviews() {
    ...
    let overflowCanvasSize = CGSize(
      width: self.bounds.width * overflowCanvasSizeRatio,
      height: self.bounds.height * overflowCanvasSizeRatio)
...
func getFactors(_ fromSize: CGSize, toRect: CGRect) -> (
  xScalingFactor: CGFloat, yScalingFactor: CGFloat, lineWidthScalingFactor: CGFloat,
  fillIsHorizontal: Bool, offset: CGFloat
) {
...
func drawBackspace(_ bounds: CGRect, color: UIColor) {
  ...
  bezierPath.addCurve(
    to: CGPoint(x: 44 * xScalingFactor, y: 26 * yScalingFactor),
  ...
  bezierPath.addCurve(
    to: CGPoint(x: 44 * xScalingFactor, y: 6 * yScalingFactor),
...
func drawShift(_ bounds: CGRect, color: UIColor, withRect: Bool) {
  ...
  centerShape(
    CGSize(width: 38 * xScalingFactor, height: (withRect ? 34 + 4 : 32) * yScalingFactor),
    toRect: bounds)
  ...
  bezierPath.addCurve(
    to: CGPoint(x: 14 * xScalingFactor, y: 32 * yScalingFactor),
  ...
  bezierPath.addCurve(
    to: CGPoint(x: 24 * xScalingFactor, y: 32 * yScalingFactor),
  ...
  bezierPath.addCurve(
    to: CGPoint(x: 28 * xScalingFactor, y: 28 * yScalingFactor),
  ...
  bezierPath.addCurve(
    to: CGPoint(x: 28 * xScalingFactor, y: 18 * yScalingFactor),
  ...
  if withRect {
    ...
    let rectanglePath = UIBezierPath(
      rect: CGRect(
        x: 10 * xScalingFactor, y: 34 * yScalingFactor, width: 18 * xScalingFactor,
        height: 4 * yScalingFactor))
    color2.setFill()
    rectanglePath.fill()
  }
...
func drawGlobe(_ bounds: CGRect, color: UIColor) {
  ...
  let ovalPath = UIBezierPath(
    ovalIn: CGRect(
      x: 0 * xScalingFactor, y: 0 * yScalingFactor, width: 40 * xScalingFactor,
      height: 40 * yScalingFactor))
  color.setStroke()
  ...
  bezier3Path.addCurve(
    to: CGPoint(x: 21.63 * xScalingFactor, y: 39.6 * yScalingFactor),
  ...
  bezier4Path.addCurve(
    to: CGPoint(x: 18.72 * xScalingFactor, y: 39.6 * yScalingFactor),
  ...
  bezier5Path.addCurve(
    to: CGPoint(x: 34 * xScalingFactor, y: 7 * yScalingFactor),
  ...
  bezier6Path.addCurve(
    to: CGPoint(x: 34 * xScalingFactor, y: 33 * yScalingFactor),
